#!/usr/bin/env python3
"""Batch generate wallpaper images with prompt variety."""
import argparse
import subprocess
import sys
...
def main():
    ...
    parser.add_argument("--theme", required=True, help="Prompt theme (from wallpapers/ category)")
    ...
    print(f"Batch: {args.count} wallpapers, theme='{args.theme}'")
